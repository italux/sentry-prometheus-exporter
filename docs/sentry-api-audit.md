...
| `issue_events(issue_id, environment=None, ...)` | `/api/0/organizations/{organization_id_or_slug}/issues/{issue_id}/events/?environment={env}&sort=date` | https://docs.sentry.io/api/events/list-an-issues-events/ | Current | Bug fix: query string construction | — |
| `issue_release(issue_id, environment=None)` | `/api/0/organizations/{organization_id_or_slug}/issues/{issue_id}/current-release/` (with optional `?environment={env}`) | https://docs.sentry.io/api/events/retrieve-the-current-release-for-an-issue/ | Current | None | — |
...
| `project_releases(org_slug, proj_slug, query=None, environment=None)` | `/api/0/projects/{organization_id_or_slug}/{project_id_or_slug}/releases/` | https://docs.sentry.io/api/releases/list-releases/ | Current | None | — |
| `rate_limit()` | `/api/0/rate-limit/` | https://docs.sentry.io/api/rest-api-overview/#rate-limit-information | Current | None | — |
